    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecureQuestions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Deleted = table.Column<bool>(type: "bit", nullable: false),
                    BanExpiratonDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    BannedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    SecureQuestionId = table.Column<int>(type: "int", nullable: false),
                    SecureAnswer = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_SecureQuestions_SecureQuestionId",
                        column: x => x.SecureQuestionId,
                        principalTable: "SecureQuestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApproveState = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Deleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("00a98c8e-6a15-4447-9343-063f4f1efefc"), "bd9ea5f3-2f67-4ebc-a8f3-49e6144fa04b", "User", "USER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("1bfc496b-ebd2-4c5a-b3e8-4b2c1e334391"), "077d9d59-8582-4e63-9ef7-df57d251e412", "Moderator", "MODERATOR" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { new Guid("aec1eede-5f3f-43ba-9ec3-454a3002c013"), "297a09dc-598f-4315-a6f8-505d9558f04b", "Administrator", "ADMINISTRATOR" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_SecureQuestionId",
                table: "AspNetUsers",
                column: "SecureQuestionId");
